...
namespace NStack.SDK.Services
{
    public interface INStackLocalizeService
    {
        ...
        Task<DataMetaWrapper<TSection>> GetDefaultResourceAsync<TSection>(NStackPlatform platform) where TSection : ResourceItem;
        ...
        Task<DataMetaWrapper<TSection>> GetResourceAsync<TSection>(int id) where TSection : ResourceItem;
        ...
        Task<DataMetaWrapper<TSection>> GetResourceAsync<TSection>(string locale, NStackPlatform platform) where TSection : ResourceItem;
